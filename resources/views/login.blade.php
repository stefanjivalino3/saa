  ...
  <div class="container"> 
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="/" class="signup-btn"><i class="fa fa-sign-out"></i><span class="d-none d-md-inline-block">Back</span></a></div></li>
      </ul>
    <!-- /.navbar-collapse --> 
  </div>
</nav>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form method="post" action="{{ url ('/main/checklogin')}}" class="login100-form validate-form flex-sb flex-w">
					{{ csrf_field() }}
